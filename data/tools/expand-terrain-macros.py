...
for filename in args.filenames:
 ...
 by expand-terrain-macros.py")
            ...
            for i in range(2**len(optional_params) - 2, -1, -1):
                enabled_map = {param: i & (
                    1 << index) != 0 for index, param in enumerate(optional_params)}
                ...
                result.append("#define " + basename + suffix +
                              " " + " ".join(params_external))
                result.append(
                    "    {" + basename + base_macro_suffix + " " + " ".join(params_internal) + "}")
