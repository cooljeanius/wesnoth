...
class DataSub(Data):
    ...
    def insert_after(self, previous, data):
        ...
        if previous not in self.data: return self.insert_first(data)
    ...
    def get_first(self, name, default = None):
        ...
        if name not in self.dict or not self.dict[name]: return default
    ...
    def get_all(self, name):
        ...
        if name not in self.dict: return []
