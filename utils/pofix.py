...
game_stringfixes = {
    ...
    "wesnoth": (
        ...
        ("You don’t have enough gold to recruit that unit",
         "You do not have enough gold to recruit that unit"),

        # conversion added in 1.13.6+dev
        ("The server accepts versions '$version1' while you are using version '$version2'",
         "The server accepts versions '$required_version', but you are using version '$your_version'")
    ),
    ...
    "wesnoth-help": (
        ...
        ("displayed in the upper right, (under the default theme)",
         "displayed in the upper right (under the default theme)"),
        ("However the few implements", "However, the few implements"),
        ("humans can learn to wield it and able to learn",
         "humans can learn to wield it and are able to learn"),
        ...
        ("Despite orcs' reliance on raw strength",
         "Despite orcs’ reliance on raw strength"),
        ...
        ("making them a useful asset to aid in an army's charge.",
         "making them a useful asset to aid in an army’s charge."),
    ...
    "wesnoth-httt": (
        ...
        ("Who then is your leader? Who do we serve?",
         "Who then is your leader? Whom do we serve?"),
        # fix added in 1.13.10+dev
        ("might we ask your assistance.", "might we ask your assistance?"),
        ("Onward men!", "Onward, men!"),
        ("No we have not.", "No, we have not."),
        ("If it is necessary, princess, I will ask",
         "If it is necessary, Princess, I will ask"),
        ("What secret Delfador?", "What secret, Delfador?"),
        ("I High Provost", "I, High Provost"),
        ("both a great combatant and leader",
         "both a great combatant and a leader"),
        ("You must lead your men to the city and help defend it. Or recapture it if it falls before you arrive.",
         "You must lead your men to the city. Help defend it, or recapture it if it falls before you arrive!"),
        # fix added in 1.13.11+dev
        ("with the greatest generals, and battle tactics",
         "with the greatest generals and battle tactics"),
        # fixes added in 1.14.3+dev
        ("Whatever.... I still think we should make an effort",
         "Whatever... I still think we should make an effort"),
        ("That is so very encouraging....", "That is so very encouraging..."),
        # fixes added in 1.15.1+dev
        ("This unit's grasp of melee tactics",
         "This unit’s grasp of melee tactics"),
    ...
    "wesnoth-nr": (
        ...
        ("They are stronger then we thought.",
         "They are stronger than we thought."),
        ("Hmmm, they are stronger then we thought",
         "Hmmm, they are stronger than we thought"),
        ("torment other then self destruction.",
         "torment other than self destruction."),
        ("Rod of Justice for more then a few",
         "Rod of Justice for more than a few"),
        ("you have aided the Northern Elves more then you can imagine.",
         "you have aided the Northern Elves more than you can imagine."),
        ("been more then a few months ago", "been more than a few months ago"),
        ("they cannot be more then two days’ march from here.",
         "they cannot be more than two days’ march from here."),
        ("It couldna’ been more then a day now.",
         "It couldna’ been more than a day now."),
        ("It couldna’ ha’ been more then a day now.",
         "It couldna’ ha’ been more than a day now."),
        ("They are no more then a few days", "They are no more than a few days"),
        ("fearsome a foe then a dwarf.", "fearsome a foe than a dwarf."),
        ("hold the orcs off far longer and with less loss then ye could ha’ done",
         "hold the orcs off far longer and with less loss than ye could ha’ done"),
    ...
    "wesnoth-sota": (
        ...
        ("Welcome to my laboratory, Ardonna of Tarynth",
         "Welcome to my laboratory, Ardonna of Tarrynth"),
        # fixes added in 1.14.3+dev
    ...
    "wesnoth-sotbe": (
        # fixes added in 1.12.0+dev
        ("Easier said then done, Chief. There are many humans in that city.",
         "Easier said than done, Chief. There are many humans in that city."),
        ("then your kind can. Take the orcish prisoners and hurry to Melmog.",
         "than your kind can. Take the orcish prisoners and hurry to Melmog."),
        ("Better late then never. Now it’s time to kill!",
         "Better late than never. Now it’s time to kill!"),
        ("becomes no less then a boot-licking spy for the humans.",
         "becomes no less than a boot-licking spy for the humans."),
        ("consequently, those orcs thirsting for battle got more then",
         "consequently, those orcs thirsting for battle got more than"),
    ),
    ...
    "wesnoth-trow": (
        # fixes added in 1.14.3+dev
        ("a noble of the line of Kings should utter the following....",
         "a noble of the line of Kings should utter the following..."),
    ),
    ...
    "wesnoth-units": (
        ...
        ("and are valuable enough that auxilliaries who specialize",
         "and are valuable enough that auxiliaries who specialize"),
        ("Their remedies cannot only heal wounds",
         "Their remedies can not only heal wounds"),
        # fix added in 1.13.11+dev
        ("the singleminded tenacity of an oak.",
         "the single-minded tenacity of an oak."),
    ),

    "wesnoth-utbs": (
        # fixes added in 1.12.0+dev
        ("On the tallest peak was build", "On the tallest peak was built"),
        ("He killed himself rather then surrender to us!",
         "He killed himself rather than surrender to us!"),
        ("bigger distraction then they were expecting.",
         "bigger distraction than they were expecting."),

        # added in 1.13.14+dev
        ("the one thing she not will be anticipating.",
         "the one thing she will not be anticipating."),
    ...
    "wesnoth-multiplayer": (
        # 1.13.4+dev
        ("Changes the gold worth of the enemy spawns by a certain perentage",
         "Changes the gold worth of the enemy spawns by a certain percentage"),
        # fixes added in 1.14.3+dev
        ("Rah Ihn Mar began the hunt.....", "Rah Ihn Mar began the hunt..."),
        ("Perhaps he should not have shouted quite so loudly.... ",
         "Perhaps he should not have shouted quite so loudly..."),
        ("but the two men never found one another. ",
         "but the two men never found one another."),
    ),
