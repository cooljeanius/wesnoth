...
try:
    ...
    print(
        "Failed to import 'multiprocessing' module. Multiple cpu cores won't be utilized"
    )
    parallel_map = map
...
if __name__ == "__main__":
    ...
    for arg in args.paths:
        for path in glob.glob(arg):
            if (
                not path.endswith(".po")
                and not path.endswith(".pot")
                and not path.endswith(".cfg")
    ...
    print(
        "pofix: %d files processed, %d files modified, %d files newer"
